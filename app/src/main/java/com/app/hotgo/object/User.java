...
public class User {
    ...
    private String typeTasker;
    private ShopObj shopObj;

    public ShopObj getShopObj() {
        return shopObj;
    }

    public void setShopObj(ShopObj shopObj) {
        this.shopObj = shopObj;
    }

    public String getTypeTasker() {
        return typeTasker;
    }

    public void setTypeTasker(String typeTasker) {
