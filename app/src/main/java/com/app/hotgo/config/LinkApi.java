...
public class LinkApi {
    ...
    public static final String SEND_TRIP_REQUEST = "http://uat.hicominfo.com:8888/upro-v2-heinz/stripe/web/index.php";
    //    public static final String SEND_TRIP_REQUEST = "http://bestapp.site/graduationproject/api/";
    // PrepareLogin
    public static final String PREPARELOGIN = "prepareLogin";
    // authorize
    public static final String AUTHORRIZE = "authorize";
    // Register
    public static final String REGISTER = "updateProduct";
    // Token
    ...
    public final static String SEARCH_DRIVER_NUMBER =
            "searchDriver";
    public final static String SEARCH_PRODUCT =
            "searchProduct";
    public final static String SHOW_PRODUCT_BY_CATEGORY = "showListShopByCategory";
    ...
    public final static String FORGOTPASSWORD =
            "forgotPassword";
    public final static String CHANGE_STATUS =
            "changeStatus";
    // ===================== GOOGLE API =====================
    ...
    public final static String SHOW_CAR_TYPE = "showCarType";
    public final static String CHANGE_PASSWORD = "changePassword";
    public final static String TASKER_DELETE_REQUEST = "taskerDeleteRequest";
    public final static String TASKER_DISMISS_REQUEST = "dismissRequest";

    public final static String REGISTER_SHOP = "registerShop";
    public final static String REGISTER_SHIPPER = "registerShipper";
    public final static String UPDATE_SHOP = "updateShop";
    public final static String UPDATE_SHIPPER = "updateShipper";
    public final static String ADD_NEW_PRODUCT = "addProduct";
    public final static String UPDATE_PRODUCT = "updateProduct";
    public final static String GET_LIST_PRODUCT = "showListProduct";
    public final static String RATE_PRODUCT = "rateProduct";
    ...
    public static final String FIREBASE_URL = "https://taxinear-c804e.firebaseio.com/";
}
